...
snd_pcm_format_t hardware_params::set_best_standard_pcm_format_type(snd_pcm_t* pcm, snd_pcm_hw_params_t* hw_params,
                                                                    snd_pcm_format_t type, alsa_error* error)
{
    ...
    if( err = snd_pcm_hw_params_set_format(pcm, hw_params, type); err < 0 ) {
        ...
        type = pcm_format_type_mask::best_fallback_standard_pcm_format_type(type_mask, type);
...
snd_pcm_format_t pcm_format_type_mask::best_fallback_standard_pcm_format_type(const snd_pcm_format_mask_t* mask, snd_pcm_format_t type)
{
    ...
    static const format_array S16Fallback[] = {S16, S24, S32, Float, F64};
    static const format_array S24Fallback[] = {S24, S32, Float, F64, S16};
    static const format_array S32Fallback[] = {S32, F64, Float, S24, S16};
    static const format_array FloatFallback[] = {Float, F64, S32, S24, S16};
    static const format_array F64Fallback[] = {F64, Float, S32, S24, S16};
    ...
    case SND_PCM_FORMAT_FLOAT64_BE:
        ...
        break;
    default:
        assert(false); // not a standard pcm type
    }
