...
namespace lbu {
    ...
    public:
        ...
        array_ref(array_ref<typename std::enable_if<std::is_const<U>::value || std::is_volatile<U>::value, std::remove_cv_t<U>>::type,
                            SizeType> array) : d(array.data()), n(array.size())
        {
        }
